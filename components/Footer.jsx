        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-14">
          ...
          <div>
            ...
            <p className="mt-6 text-[15px] leading-7 text-white/70 max-w-sm">
              ...
              para marcas, lideranças e projetos com impacto real.
            </p>
          </div>

          {/* COLUNA 2 */}
          <div>
            <h3 className="text-sm uppercase tracking-[0.18em] text-white/40 mb-5">
              Navegação
            </h3>
          ...
          <div>
            ...
            <div className="space-y-3 text-[15px] text-white/80">
              ...
              <a
                ...
                className="block hover:text-[#FF4D00] transition break-all"
              >
                andre@andretomazela.com.br
              </a>
            </div>

            <div className="flex items-center gap-5 mt-7 text-white/80">
              <a
                href="https://wa.me/message/TUNCL3KFQIECM1"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp"
                className="hover:text-[#FF4D00] transition"
              >
                <IconWhatsApp />
              </a>
